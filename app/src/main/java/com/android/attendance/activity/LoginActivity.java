		...
		login.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				else if (userrole.equals("faculty"))
				{
					...
					// Validate student credentials and redirect to student dashboard
					// Example: Suppose student credentials are "student" for both username and password
					if (user_name.equals("student") && pass_word.equals("student")) {
